...
{$ENDREGION}
  IXMLText = interface(IItemSerialize<String>)
...
{$REGION 'documentation'}
{
  ...
  @member(
    Decompose Converts XML text data type to transportable string
    @param(Text XML text)
    @return(String with data type decomposed)
  )
  @member(
    Compose Converts transportable string to XML text data type
    @param(Value Transportable string)
    @return(XML string data type)
  )
...
{$ENDREGION}
  ...
  public
    ...
    function Compose(const Value: String): String;
...
{$REGION 'documentation'}
{
  ...
  @member(
    Decompose Converts XML date/time data type to transportable string
    @param(DateTime XML date/time)
    @return(String with data type decomposed)
  )
  @member(
    Compose Converts transportable string to XML date/time data type
    @param(Value Transportable string)
...
{$ENDREGION}
  ...
  public
    ...
    function Compose(const Value: String): TDateTime;
...
function TXMLText.Decompose(const Text: String): String;
begin
  Result := Text;
...
function TXMLText.Compose(const Value: String): String;
begin
  Result := Value;
  Result := StringReplace(Result, '&', '&amp;', [rfReplaceAll]);
  Result := StringReplace(Result, '"', '&quot;', [rfReplaceAll]);
...
function TXMLDateTime.Decompose(const DateTime: TDateTime): String;
begin
  Result := FormatDateTime('yyyy-MM-dd"T"hh:nn:ss', DateTime);
end;

function TXMLDateTime.Compose(const Value: String): TDateTime;
var
